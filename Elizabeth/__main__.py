...
PM_START_TEXT = f"""
`Hi..Welcome` 👀
`I'm` [✔️ NIKITA🍀](https://telegra.ph/file/281aaa468756db0769df0.jpg)
...
buttons += [[InlineKeyboardButton(text="💾SOURCE CODE",
                                  url="⚠️ERROR 🚫 404🚫NOT FOUND TRY AGAIN LATER ‼️☢️ ⚠️"),
...
HELP_STRINGS = f"""
`Hi.. I'm` [✔️NIKITA🍀](https://telegra.ph/file/6cf3dfe51c66e1b823725.jpg)
